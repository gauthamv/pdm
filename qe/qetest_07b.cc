...
//	cout << endl << "***** In QE Test Case 7B *****" << endl;
//
//	RC rc = success;
//
...
//			cout << endl << "***** Stopping the join process on purpose. The contents in the directory will be checked. *****" << endl;
//			break;
//		}
//	}
//
...
//int main() {
//
//	if (testCase_7B() != success) {
//		cout << "***** [FAIL] QE Test Case 7B failed. *****" << endl;
//		return fail;
//	} else {
//		cout << "***** QE Test Case 7B finished. The result and the contents in the directory will be examined. *****" << endl;
//		return success;
//	}
//}
